...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      next_doc_number: { Args: never; Returns: string }
      pode_cliente: { Args: { _cliente_id: string }; Returns: boolean }
      pode_instalacao: { Args: { _instalacao_id: string }; Returns: boolean }
    }
    Enums: {
